...
namespace KDL
{
    ...
    public:
        ...
        FrameVel(const Frame &_T, const Twist &_t) : M(_T.M, _t.rot), p(_T.p, _t.vel) {}
...
template <>
struct std::hash<KDL::RotationVel>
{
